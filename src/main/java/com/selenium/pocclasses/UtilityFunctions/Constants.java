...
public class Constants {
    ...
    public  static final  String FileName_Login_Credentials="txt.csv";

    //We can pass static data from constants files
    public  static final  String scardNumber="411111111111111111";
